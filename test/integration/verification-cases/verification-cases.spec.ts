...
import type { Tables } from "../../../services/store/Tables";
import type { MatchLevel } from "../../../routes/types";
...
export interface VerificationTestCase {
  ...
  output: {
    creationBytecode: string;
    deployedBytecode: string;
    compilationArtifacts: Tables.ICompiledContract["compilation_artifacts"];
    creationCodeArtifacts: Tables.ICompiledContract["creation_code_artifacts"];
    runtimeCodeArtifacts: Tables.ICompiledContract["runtime_code_artifacts"];
    metadata: Metadata;
  };
  /*
...
describe("Specific Verification Cases", function () {
  ...
  const testVerificationCase = async (testCase: VerificationTestCase) => {
    ...
    const verifyRes = await chai
      ...
      .post(
        `/verify/${chainFixture.chainId}/${deploymentInfo.contractAddress}`,
      )
      .send({
