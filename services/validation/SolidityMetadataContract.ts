...
import {
  ...
  StringMap,
  ValidationError,
  convertLibrariesToStdJsonFormat,
} from '@ethereum-sourcify/lib-sourcify';
import {
  AuxdataStyle,
  decode as decodeBytecode,
} from "@ethereum-sourcify/bytecode-utils";
import { ipfsHash } from "@ethereum-sourcify/lib-sourcify/build/main/Validation/hashFunctions/ipfsHash";
import {
  swarmBzzr0Hash,
  swarmBzzr1Hash,
} from "@ethereum-sourcify/lib-sourcify/build/main/Validation/hashFunctions/swarmHash";
import {
  generateVariations,
  groupBy,
  getVariationsByContentHash,
  reorderAlphabetically,
} from "@ethereum-sourcify/lib-sourcify/build/main/Validation/variationsUtils";
import { logDebug } from "@ethereum-sourcify/compilers/build/main/logger";
